...
|---:|---|---|---|---|
| **1** | **VinFast — Customer Service / Aftersales** | Repetitive + Time-consuming | Tự động đọc tin nhắn/email của khách từ nhiều nguồn, gom lại các thông tin chính rồi chuyển cho đúng người giải quyết hoặc tự trả lời nếu là FAQ. | Quy trình VinFast công khai xác nhận CSKH nhận yêu cầu từ hotline, email, website, app và thư; sau đó có bước **phân loại và chuyển xử lý**. |
| **2** | **Vinpearl — Reservation / Customer Service** | Repetitive + Time-consuming | Trích xuất thông tin booking từ đoạn tin nhắn của khách | JD Vinpearl công khai cho thấy nhân viên tiếp nhận yêu cầu đặt vé/phòng/dịch vụ và thực hiện đặt/xuất/hủy/thay đổi qua B2B hoặc đối tác. |
...
|---|---:|---:|---:|---:|---|
| Điều phối và phân loại trong CSKH VinFast | **Cao** | **Cao** | **Cao với text tự do; Rule vẫn cần cho hard constraints** | Trung bình | **Top 3** |
...
## Quick Problem Card #1 — Điều phối và giải quyết yêu cầu khách hàng trong CSKH VinFast
