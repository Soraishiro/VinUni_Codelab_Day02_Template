...
- Ghi rõ thời gian vận hành trung bình: **Tổng cộng = \_\_\_\_ phút/lượt**.
...
| **5. Success Metric**       | AI giải quyết được thì đạt ngưỡng số mấy? (Ví dụ: _"85% vé được phân loại dưới 10s"_). |
